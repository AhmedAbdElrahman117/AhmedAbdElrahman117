...
- 🎓 **Fresh Grad & High-Mid Level Dev** from Egypt (fueled by coffee, dark mode, and approaching deadlines)
- 📱 Building pixel-perfect, scalable mobile apps with **Flutter** & **Jetpack Compose**
- 🎖️ Certified in Android Native Development by the **Digital Egypt Pioneers Initiative (DEPI)**
- 👨‍🏫 Experienced in leading teams and technical instruction
- 🌍 Currently: Grinding on side quests and building cool things like **RestoQR**

---

### 🔥 What I Do

| 📱 App | 💡 What is it? | 🛠️ Built With |
| ------ | ------------- | ------------ |
...
- 🧛‍♂️ I strictly operate in **Dark Mode**. Light mode is a myth.
- 🐛 "It’s not a bug, it’s a surprise feature."
- 🗣️ "If at first you don’t succeed, call it version 1.0."
- 🎧 Probably listening to music or debugging a UI layout right now.
